...
public:
    ...
    Isle *findIsle(MapNode *node, Isle isle);
    Isle *findIsle(MapNode *node, std::string name);

    MapNode *findNode(Isle isle);
    MapNode *findNode(std::string name);

    MapNode *findNode(MapNode *node, Isle isle);
    MapNode *findNode(MapNode *node, std::string name);
    ...
    int getIsleDepth(MapNode* node, Isle* isle, int depth);


    MapNode* minNode(MapNode* node);
